...
const config: Config = {
	...
	organizationName: 'JQChong', // Usually your GitHub org/user name.
		...
		[
			'classic',
			{
				docs: {
					...
					editUrl: 'https://github.com/JQChong/jet-lag/tree/master/',
				},
				// blog: {
	...
	themeConfig: {
		...
		navbar: {
			...
			items: [
				...
				{
					href: 'https://github.com/JQChong/jet-lag',
					label: 'GitHub',
					position: 'right',
				},
			],
