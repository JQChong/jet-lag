...
export const cardDefinitions: Card[] = [
	{
		file: 'time_bonus_5',
		count: 20, //originally 25
		hasMorePages: false,
		canUse: (hand) => false,
	},
	{
		file: 'time_bonus_10',
		count: 12, //originally 15
		hasMorePages: false,
		canUse: (hand) => false,
	},
	{
		file: 'time_bonus_15',
		count: 6, //originally 10
		hasMorePages: false,
		canUse: (hand) => false,
	},
	{
	...
	{
		file: 'curse_distant_cuisine_v2',
		count: 1,
		hasMorePages: false,
		useText: 'To use this card, you must be at the stall.',
		canUse: (hand) => true,
	},
	{
	...
	{
		file: 'curse_imaginary_sinkhole_micro',
		count: 1,
		hasMorePages: false,
		useText: "To use this card, seekers must be 250m away from the boundary of the sinkhole.",
		canUse: (hand) => true,
	},
	{
		file: 'curse_sloth',
